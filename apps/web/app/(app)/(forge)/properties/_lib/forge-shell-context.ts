...
// customers/_lib/forge-shell-context.ts (each (forge) route builds its own
// shell chrome internally, per PR #125's architecture) — reused by both
// apps/web/app/(app)/(forge)/properties/page.tsx and
// .../[propertyId]/page.tsx.
