...
// from real Forge org/session context (ActiveOrgContext from
// getActiveOrgContext, plus the signed-in user). Reused by every route under
// (forge)/estimates so all estimate pages present identical shell chrome.
// Copied from ../../requests/_lib/forge-shell-context.ts (same pattern as
// customers/properties/team/requests/site-visits).
