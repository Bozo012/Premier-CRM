...
// customers/_lib/forge-shell-context.ts and properties/_lib/forge-shell-context.ts
// (each (forge) route builds its own shell chrome internally, per PR #125's
// architecture) — reused by site-visits/page.tsx, site-visits/[siteVisitId]/page.tsx,
// and site-visits/[siteVisitId]/inspection/page.tsx.
