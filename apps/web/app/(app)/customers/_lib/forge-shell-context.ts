...
// getActiveOrgContext, plus the signed-in user). Reused by both
// apps/web/app/(app)/customers/page.tsx and
// apps/web/app/(app)/customers/[customerId]/page.tsx so the two routes on
// the new shell present identical shell chrome.
