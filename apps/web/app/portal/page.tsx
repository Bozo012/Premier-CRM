...
// Customer-facing: kept tenant-branded rather than routed through the
// product's title template (root layout's "Forge — %s") — a customer
// should see the business they're dealing with, not the platform name.
export const metadata: Metadata = {
  title: { absolute: 'Premier Property Maintenance — Customer Portal' },
};
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
      <section className="space-y-4 text-center sm:py-8">
        ...
        <p className="mx-auto max-w-2xl text-base text-muted-foreground sm:text-lg">
          ...
          The portal lives inside {PRODUCT_NAME} at app.ppmnky.com/portal so protected
      ...
      <Card>
        <CardContent className="pt-6 text-sm text-muted-foreground">
          Customer portal accounts are separate from {PRODUCT_NAME} internal staff accounts.
